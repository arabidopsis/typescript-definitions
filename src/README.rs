...
There is a very small example in the repository that [works for me (TM)](https://github.com/arabidopsis/typescript-definitions/src/master/example/) if you want to get started on your own.
